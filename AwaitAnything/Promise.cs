...
namespace AwaitAnything
{
    ...
    {
        // generic object
        public Deferred(Action<Promise<object>> c) : base(c)
        {
        }
    ...
    public class Deferred<T> : Promise<T>
    {
        ...
        private T _arg;
        private Action<Deferred<T>> function;

        public Deferred(Action<Deferred<T>> c)
        {
            function = c;
        }
        public Deferred()
        ...
        public IAwaiter<T> GetAwaiter() => new PromiseAwaiter<T>(function);
